...
//   const [attendanceStep, setAttendanceStep] = useState('capture'); // 'capture' | 'select' | 'done'
...
//       const response = await axios.post(`${API_URL}/recognize-face`, fd, {
...
//           showMessage(`Welcome ${response.data.labour.name}!`, 'success');
//         }
...
//   // Step 2: Submit Attendance with Site/Type/Category
...
//               }`}
//               onClick={() => { setMode('attendance'); resetAll(); }}
//             >
//               📋 Mark Attendance
//             </button>
//             <button
...
//                           Step 1: Capture your face for recognition
//                         </p>
//                       </div>

//                       {/* Tips */}
//                       <div className="bg-blue-50 border-l-4 border-blue-400 rounded-r-lg p-4">
//                         <p className="text-blue-900 font-semibold text-sm mb-2">💡 Tips</p>
...
//                             <span className="text-gray-800 font-semibold">{attendanceResult.labour?.name}</span>
//                           </div>
//                           <div className="flex justify-between border-b border-gray-100 pb-1.5">
//                             <span className="text-gray-500">🏗️ Site</span>
//                             <span className="text-gray-800 font-semibold">{attendanceResult.attendance?.site}</span>
//                           </div>
//                           <div className="flex justify-between border-b border-gray-100 pb-1.5">
//                             <span className="text-gray-500">👷 Type</span>
//                             <span className="text-gray-800 font-semibold">{attendanceResult.attendance?.labourType}</span>
//                           </div>
//                           {attendanceResult.attendance?.category && (
//                             <div className="flex justify-between border-b border-gray-100 pb-1.5">
//                               <span className="text-gray-500">📂 Category</span>
//                               <span className="text-gray-800 font-semibold">{attendanceResult.attendance?.category}</span>
//                             </div>
//                           )}
//                           <div className="flex justify-between border-b border-gray-100 pb-1.5">
//                             <span className="text-gray-500">🕐 Check-in</span>
//                             <span className="text-gray-800 font-semibold">{attendanceResult.attendance?.checkInTime}</span>
//                           </div>
//                           {attendanceResult.attendance?.checkOutTime && (
//                             <>
//                               <div className="flex justify-between border-b border-gray-100 pb-1.5">
//                                 <span className="text-gray-500">🕐 Check-out</span>
//                                 <span className="text-gray-800 font-semibold">{attendanceResult.attendance?.checkOutTime}</span>
//                               </div>
//                               <div className="flex justify-between">
//                                 <span className="text-gray-500">⏱️ Working Hours</span>
//                                 <span className="text-gray-800 font-bold">{attendanceResult.attendance?.workingHours}</span>
//                               </div>
//                             </>
//                           )}
//                         </div>
...
//                     <p className="text-gray-500 text-sm mt-1">
//                       Fill details and capture 3–5 photos
//                     </p>
//                   </div>
...
//               {/* Message Box */}
//               {message && (
//                 <div className={`mt-4 p-3 rounded-xl flex items-start gap-2 text-sm border ${
//                   messageType === 'success'
...
//           <p>🔒 Powered by Face Recognition AI · Secure & Fast Attendance System</p>
//         </div>
//       </div>
//     </div>
//   );
