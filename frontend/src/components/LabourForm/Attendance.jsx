...
//       head: false, contractorName: true, companyPayment: false,
//       contractorDebitPayment: false, amount: false,
//     },
//     'Outsource Labor': {
//       name: true, designation: false, category: true, code: true, photo: true,
//       inTime: true, shift: true, dayType: true, workDescription: true,
//       head: true, contractorName: false, companyPayment: false,
//       contractorDebitPayment: false, amount: false,
//     },
//     'Company Staff': {
//       name: true, designation: true, category: true, code: true, photo: true,
//       inTime: true, shift: false, dayType: false, workDescription: false,
//       head: false, contractorName: false, companyPayment: false,
//       contractorDebitPayment: false, amount: false,
//     },
//     'Contractor Staff': {
//       name: true, designation: true, category: true, code: true, photo: true,
...
//                       <div>
//                         <label className="block font-medium mb-2">👤 Name / नाम *</label>
//                         <select value={newLaborer.name} onChange={e => handleNameChange(e.target.value)} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
//                           <option value="">Select Name</option>
//                           {employeeNames.map((emp, i) => <option key={i} value={emp.name}>{emp.name}</option>)}
//                         </select>
//                       </div>
//                     )}
...
//                       <div>
//                         <label className="block font-medium mb-2">💼 Designation / पदनाम</label>
//                         <input type="text" value={newLaborer.designation} onChange={e => setNewLaborer({...newLaborer, designation: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="Designation" />
//                       </div>
//                     )}
...
//                       <div>
//                         <label className="block font-medium mb-2">📂 Category / श्रेणी</label>
//                         <input type="text" list="categoriesList" value={newLaborer.category} onChange={e => setNewLaborer({...newLaborer, category: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="Category" />
//                         <datalist id="categoriesList">
...
//                       <div>
//                         <label className="block font-medium mb-2">🆔 {codeLabel}</label>
//                         <input type="text" value={newLaborer.code} readOnly className="w-full p-3 border rounded-lg bg-gray-100 cursor-not-allowed" placeholder="Auto-filled..." />
//                       </div>
//                     )}
//                   </div>
...
//                       <div>
//                         <label className="block font-medium mb-2">🕒 Shift / पाली</label>
//                         <select value={newLaborer.shift} onChange={e => setNewLaborer({...newLaborer, shift: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
//                           <option value="">Select Shift</option>
...
//                       <div>
//                         <label className="block font-medium mb-2">📅 Day Type / दिन प्रकार</label>
//                         <select value={newLaborer.dayType} onChange={e => setNewLaborer({...newLaborer, dayType: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
//                           <option value="">Select Day Type</option>
...
//                       <div>
//                         <label className="block font-medium mb-2">👨‍💼 Head / विभाग</label>
//                         <select value={newLaborer.head} onChange={e => setNewLaborer({...newLaborer, head: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
//                           <option value="">Select Head</option>
//                           <option value="Company Head">Company Head</option>
//                           <option value="Contractor Head">Contractor Head</option>
//                         </select>
...
//                       <div>
//                         <label className="block font-medium mb-2">🏢 Contractor / ठेकेदार</label>
//                         <select value={newLaborer.contractorName} onChange={e => setNewLaborer({...newLaborer, contractorName: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200">
//                           <option value="">Select Contractor</option>
//                           {contractorNames.map((c, i) => <option key={i} value={c}>{c}</option>)}
//                         </select>
//                       </div>
//                     )}
//                   </div>
...
//                       <div>
//                         <label className="block font-medium mb-2">💰 Company Payment</label>
//                         <input type="number" value={newLaborer.companyPayment} onChange={e => setNewLaborer({...newLaborer, companyPayment: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="0.00" />
//                       </div>
//                     )}
...
//                       <div>
//                         <label className="block font-medium mb-2">💸 Contractor Debit Payment</label>
//                         <input type="number" value={newLaborer.contractorDebitPayment} onChange={e => setNewLaborer({...newLaborer, contractorDebitPayment: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="0.00" />
//                       </div>
//                     )}
...
//                       <div>
//                         <label className="block font-medium mb-2">💵 Amount / राशि</label>
//                         <input type="number" value={newLaborer.amount} onChange={e => setNewLaborer({...newLaborer, amount: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200" placeholder="₹0.00" />
//                       </div>
//                     )}
//                   </div>
...
//                     <div>
//                       <label className="block font-medium mb-2">📝 Work Description / कार्य विवरण</label>
//                       <textarea value={newLaborer.workDescription} onChange={e => setNewLaborer({...newLaborer, workDescription: e.target.value})} className="w-full p-3 border rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200" rows={3} placeholder="Work details..." />
//                     </div>
//                   )}
...
//                       ) : (
//                         <div className="flex flex-col sm:flex-row gap-4">
//                           <button onClick={() => startCamera('user')} className="flex-1 bg-blue-600 text-white py-4 rounded-lg font-bold flex items-center justify-center gap-2 hover:bg-blue-700 transition">
//                             <Camera size={20} /> Open Camera
//                           </button>
...
//             <div className="flex flex-col sm:flex-row gap-4">
//               <button onClick={() => handleSubmit('in')} disabled={inSubmitting || laborers.length === 0} className="flex-1 py-4 rounded-lg text-white font-bold text-lg flex items-center justify-center gap-2 transition bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed">
//                 {inSubmitting ? '⏳ Submitting...' : `🚀 Submit IN (${laborers.length})`}
//               </button>
...
//                     <label className="block font-medium mb-2">⏰ Out Time / आउट टाइम *</label>
//                     <div className="flex gap-2">
//                       <input type="text" value={newOutLaborer.outTime} readOnly className="flex-1 p-3 border rounded-lg bg-gray-100 cursor-not-allowed text-lg font-semibold text-red-600" />
//                       <button type="button" onClick={() => setNewOutLaborer({...newOutLaborer, outTime: new Date().toLocaleTimeString('en-IN', { hour12: false })})} className="px-4 py-3 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition">
//                         🔄 Update
//                       </button>
//                     </div>
//                   </div>
...
//             <div className="flex flex-col sm:flex-row gap-4">
//               <button onClick={() => handleSubmit('out')} disabled={outSubmitting || outLaborers.length === 0} className="flex-1 py-4 rounded-lg text-white font-bold text-lg flex items-center justify-center gap-2 transition bg-red-600 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed">
//                 {outSubmitting ? '⏳ Submitting...' : `🚀 Submit OUT (${outLaborers.length})`}
//               </button>
...
//     // Dropdown को close करो - search को खाली करो
//     setFirstNameSearch('');
//   };
...
//     alert(`नया नाम जोड़ा जा रहा है:\nFull Name: ${fullName}\nLabour Type: ${newEmployee.laborType}`);
...
//                   {/* DROPDOWN - first name वाली search से दिखे */}
...
//                         >
//                           {emp.name}
//                           {/* अगर सिर्फ first name है तो warning दे */}
...
//               >
//                 <Plus size={24} />
//                 {newEmployee.firstName.trim() && newEmployee.lastName.trim() && newEmployee.laborType
//                   ? '✓ Add Name'
//                   : 'सभी जानकारी भरें'}
//               </button>
//             </div>
