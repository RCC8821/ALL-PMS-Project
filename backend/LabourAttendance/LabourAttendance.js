...
//   drive,
//   LABOUR_ID,
//   SHARED_DRIVE_ID, // ✅ Add this to your config
...
// // ✅ FIXED: Upload to Shared Drive OR skip gracefully
// const uploadToGoogleDrive = async (buffer, filename) => {
//   try {
//     // Check if Shared Drive ID is configured
//     if (!SHARED_DRIVE_ID) {
//       console.log("📷 No Shared Drive configured, skipping image upload");
//       return null;
//     }
...
//         name: filename,
//         mimeType: "image/jpeg",
//         parents: [SHARED_DRIVE_ID], // ✅ Upload to Shared Drive
//       },
//       media: {
//         mimeType: "image/jpeg",
//         body: bufferStream,
...
//     // Don't fail registration, just skip image
//     return null;
//   }
// };
...
//     // Upload image (will return null if fails)
...
//   try {
//     const { labourId, site, labourType, category, contractorName } = req.body;
...
//         return res.json({
//           success: true,
//           message: `${labour.name} already checked out today at ${todayRecord[8]}`,
//           status: "completed",
//           labour: {
//             id: labour.id,
//             name: labour.name,
...
//       await sheets.spreadsheets.values.update({
//         spreadsheetId: LABOUR_ID,
//         range: `Attendance!I${rowNumber}:K${rowNumber}`,
//         valueInputOption: "RAW",
//         resource: { values: [[currentTime, workingHours, "Checked Out"]] },
//       });

//       return res.json({
//         success: true,
//         message: `Goodbye ${labour.name}! Checked out at ${currentTime}`,
//         status: "checked-out",
//         labour: {
//           id: labour.id,
//           name: labour.name,
...
//     ({ id, name, phone, imageUrl, registrationDate, defaultLabourType, defaultCategory, defaultSite }) => ({
//       id,
//       name,
//       phone,
//       imageUrl,
...
//     modelsLoaded,
//     cacheSize: faceDescriptorsCache.length,
//     sharedDriveConfigured: !!SHARED_DRIVE_ID,
