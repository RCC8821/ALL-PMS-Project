...
//       insulationTestImage,
//       continuityTestImage,
//       // safetyItems = [],    // intentionally ignored in Safety Checklist
//       helmetImage,
//       safetyShoesImage,
//       safetyGogglesImage,
//       maskImage,
...
//     // ───────────────────────────────────────────────
//     // Safety Checklist – Only images + "Done" status
//     // ───────────────────────────────────────────────
//     if (section === "Safety Checklist") {
//       const safetyImageMap = {
//         helmetImage:          { col: cols.helmet,          prefix: "elec_safety_helmet" },
...
//             });
//           } else {
//             console.warn(`Image upload failed for ${field}: ${imgData.substring(0, 60)}...`);
//           }
//         }
//       }
...
//       //   return res.status(400).json({
//       //     success: false,
//       //     error: "Safety Checklist के लिए कम से कम एक image भेजें",
//       //   });
//       // }
//     } 
//     // ───────────────────────────────────────────────
...
//       // Sheet से डेटा लाओ – range को तुम्हारे columns के हिसाब से adjust किया (DN तक अगर जरूरी हो)
//       const values = await sheets.spreadsheets.values.get({
//         spreadsheetId: Electrical_ID,
//         range: "FMS!B7:DN",  // DN तक cover कर लिया (Quality Check के लिए)
//       });
...
//       // Status columns mapping (submit वाले columnMap से मैच किया)
//       const statusMap = {
...
//       // Details with status, image, remark (और Quality Check extras)
//       const details = {
//         "Safety Checklist": {
//           status: getColumnValue("L"),
//           // individual images (अगर तुमने separate columns में डाले हैं)
...
//           remark: getColumnValue("CC"), // अगर remark column है तो
//         },
//         "Slab Conduit Layout": {
...
//       // Completed sections — सिर्फ status === "Done" (case-insensitive)
//       const completed = Object.keys(statusMap).filter((key) => {
//         const value = statusMap[key]?.toUpperCase();
//         return value === "DONE";
//       });

//       console.log(`Completed Items (${completed.length}):`, completed);
...
//         totalSections: 9,  // Safety + 7 normal + Quality Check
//       });
//     } catch (error) {
